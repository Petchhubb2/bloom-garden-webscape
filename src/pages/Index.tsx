...
const Flower = () => {
  return (
    <div className="flower animate-sway">
      ...
      <div className="container px-4 mx-auto relative z-10 flex flex-col items-center justify-between min-h-screen py-12">
        ...
        <div className="w-full flex justify-center mb-8">
          <div className="flex items-center gap-2">
            <Flower />
            <h2 className="text-2xl md:text-3xl font-semibold animate-fade-in opacity-0" style={{ animationDelay: '0.2s' }}>
              Blossom Garden
            </h2>
            <Flower />
          </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 animate-fade-in opacity-0" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl mx-auto mb-12">
            {[1, 2, 3].map((i) => (
              <div 
                key={i} 
                className="bg-white bg-opacity-50 backdrop-blur-sm p-6 rounded-2xl shadow-lg animate-fade-in opacity-0" 
        ...
        {/* Footer Quote */}
        <div className="w-full text-center mt-12 animate-fade-in opacity-0" style={{ animationDelay: '1.5s' }}>
          <p className="text-lg md:text-xl italic px-4 py-2 bg-white bg-opacity-40 backdrop-blur-sm inline-block rounded-full">
            "Let every flower remind you how beautiful life can be."
          </p>
        </div>
      </div>
    </div>
